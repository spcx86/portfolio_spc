export const metadata = {
  ...
  alternates: {
    languages: {
      'en': 'https://subhapradachand.com/2020/vercel',
      'ja': 'https://subhapradachand.com/ja/2020/vercel'
    }
  }
}
...
If you’re creating a modern frontend nothing matters more than great site performance for the user. [Google’s Lighthouse score](https://x.com/shooooobh/status/1252312827131342848), for example, is measuring your frontend performance across multiple dials that are going to greatly influence your SEO ranking.
