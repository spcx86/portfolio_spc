...
2 - Build things that don't scale - then scale them. My browser extension for manual data entry wasnt sustainable, but it got the job done until I could implement the YouTube Data API and GPT-4 mini.
